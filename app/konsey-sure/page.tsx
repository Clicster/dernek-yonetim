...
export default function KonseySurePage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white">Konsey Süre</h1>
        <p className="text-gray-400 text-sm mt-1">Konsey kadrosu süre takibi — {secilenAy}</p>
      </div>
